...
from common.utils.database import get_db_contextmanager
from common.utils.logger import logger
from common.utils.config import base_config
from common.users.model import User
from common.users.service import UserService
from common.google.gmail.service import GoogleGmailService
from common.google.token.service import GoogleTokenService
...
class GmailConsumer:
    ...
    async def _send_message_to_gmail_with_retry(
        ...
        for attempt in range(base_config.KAFKA_CONSUMER_MAX_RETRIES):
            try:
                ...
                if status in (429, 500, 505):
                    sleep_time = base_config.KAFKA_CONSUMER_BASE_BACKOFF * (2 ** (attempt - 1))
