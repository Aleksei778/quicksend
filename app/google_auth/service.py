...
from common.users.schema import FindOrCreateUser
    ...
    async def _get_redirect(
        ...
        if source == Source.Website:
            response = RedirectResponse(
                f"{base_config.FRONTEND_URL}/{lang}/profile"
            )
            ...
            response.set_cookie(
                ...
                secure=True,
                samesite="strict",
                max_age=jwt_config.JWT_ACCESS_TOKEN_EXPIRATION_HOURS * 3600,
            )
            ...
            response.set_cookie(
                ...
                secure=True,
                samesite="strict",
                max_age=jwt_config.JWT_REFRESH_TOKEN_EXPIRATION_DAYS * 3600 * 24,
            )

            return response
        else:
            return RedirectResponse(
                f"https://{base_config.EXTENSION_ID}.chromiumapp.org/callback"
